...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect{ Dessert.new("cake", 'many', "Bob") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      expect(cake.ingredients).to eq(cake.ingredients)
      cake.mix!
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cake.serve).to eq("#{chef.titleize} has made 20 cakes!")
    end
  end
